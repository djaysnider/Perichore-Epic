...
* Twelve novels in various stages of revision
* Character biographies
* Planet, technology, and historical notes
* Timelines that hopefully agree with each other
* Research material
...
Traditional version names eventually become:
...
If you're reading this repository:
...
* Where you laughed.
* Which characters you loved.
* Which characters you wanted thrown out an airlock.

Please don't spend time fixing commas. There will be editors for that someday. Right now I'm interested in story, pacing, characterization, continuity, and emotional impact.

A comment like:

> "I stopped reading here because I no longer cared."

is infinitely more valuable than:

> "You used 'its' instead of 'it's'."

(Both are appreciated. One just hurts more.)

## Canon

Nothing in this repository should be considered final.

Characters change.
Chapters move.
Entire governments occasionally get rewritten.

If something contradicts another document, assume the newest commit is winning the argument.
...
Reading random files here is like watching *The Empire Strikes Back* by starting with the last twenty minutes.
...
3. Read.
4. File issues.
5. Repeat until publication or heat death of the universe.

6. Seriously though ... the drafts are locked down. I'm happy to send an invite to serious inquiries, but I don't want to make them public.
...
*"Every draft is a hypothesis. Every revision is an experiment."*
